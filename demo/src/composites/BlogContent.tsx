            ...
            <Fragment key={`${content.__component}-${index.toString()}`}>
              ...
              {validateProsConsBlock(content) && (
                <div className="w-full grid grid-cols-2 gap-2">
                  <ul
                    className="col-span-1 flex list-disc pl-8 flex-col gap-1 border-4 border-solid border-green-500 rounded-lg p-4">
                  ...
                  <ul
                    className="col-span-1 flex flex-col pl-8 list-disc gap-1 border-4 border-solid border-red-500 rounded-lg p-4">
